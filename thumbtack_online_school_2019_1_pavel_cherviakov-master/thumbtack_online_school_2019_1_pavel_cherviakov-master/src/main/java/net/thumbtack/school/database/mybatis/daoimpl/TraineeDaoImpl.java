...
public class TraineeDaoImpl extends DaoImplBase implements TraineeDao {
    ...
    public Trainee insert(Group group, Trainee trainee) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.debug("Can't insert Trainee {}", trainee, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public Trainee getById(int id) {
        ...
        try (SqlSession sqlSession = getSession()){
            ...
            LOGGER.debug("Can't get Trainee by id {}", id, ex);
            throw ex;
        }
    }
    ...
    public Integer update(Trainee trainee) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.debug("Can't update Trainee {}", trainee, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public List<Trainee> getAllWithParams(String firstName, String lastName, Integer rating) {
        ...
        try (SqlSession sqlSession = getSession()){
               return   getTraineeMapper(sqlSession).getAllWithParams(firstName, lastName, rating);
                ...
                LOGGER.debug("Can't get all Trainees with params {}, {}, {}", firstName, lastName, rating, ex);
                throw ex;
            }
    }
    ...
    public void batchInsert(List<Trainee> trainees) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.debug("Can't insert Trainees {}", trainees, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public void delete(Trainee trainee) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.debug("Can't delete Trainee {}", trainee, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public void deleteAll() {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.debug("Can't delete all Trainees", ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public Group getOnGroupId(Integer id) {
        LOGGER.debug("DAO get Trainee");
        try (SqlSession sqlSession = getSession()) {
            return getTraineeMapper(sqlSession).getOnGroupId(id);
        } catch (RuntimeException ex) {
